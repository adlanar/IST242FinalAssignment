...
public String getFrat2Fail3(){
    return "-> \"Don't shoot!\" you say as soon as the police bust through the door to shut down the party. Your criminal history prevents you from ever having a happy life.";
}
...
public String getFrat4(){
    return "Uh oh! The PSA in the last question aparantly did not phase you! You wake up on Mars. The atmosphere will kill you in 15 minutes.";
}
...
public String getAvg4(){
    return "She laughs and says its ok. She looks a little familiar to you. Wait, she's one of your project group members!";
}
...
public String getAvg5(){
    return "She tells you she totallly forgot.";
}
